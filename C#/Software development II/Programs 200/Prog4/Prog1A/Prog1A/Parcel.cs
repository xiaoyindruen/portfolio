...
public abstract class Parcel : IComparable<Parcel>
{
    ...
    //Precondition: None
    //Postcondition: when this < other, method returns a negative number
    //               when this == other, method returns 0
    //               when this > other, method returns a positive number
    ...
    public int CompareTo(Parcel other)
    {
        if (other == null) 
            ...
            return this.CalcCost().CompareTo(other.CalcCost()); // returns the cost comparision result 
    }
}
