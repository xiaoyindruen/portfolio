...
// buile abstract class Parcel and letter class inherits from Parcelusing System;
...
namespace Prog0
{
    ...
    { // includes 4 different addresses and create 3 letters
        ...
        { // data of names and addresses of senders and receivers
            ...
            var addr4 = new Address("Nobody", "1234 Sun Ln", "Room 99", "Louisville", "KY", 40111);// address4
            ...
            var myLetter1 = new Letter(addr1, addr2, fixedCost1); //letter1
            var myLetter2 = new Letter(addr3, addr4, fixedCost2);//letter2
            var myLetter3 = new Letter(addr4, addr1, fixedCost2);//letter3

            // a list of 3 letters
            List<Parcel> myParcels = new List<Parcel>();
            myParcels.Add(myLetter1); // add letter1 to the list
            myParcels.Add(myLetter2);// add letter2 to the list
            myParcels.Add(myLetter3);// add letter3 to the list

            //Displaying addresses for producing parcels and cost
            for (int i = 0; i < myParcels.Count; i++) 
            {
                Console.WriteLine($"The parcel for the letter{i + 1}:");// print parcel of every letter in the list
